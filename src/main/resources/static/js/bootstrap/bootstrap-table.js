...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        rememberOrder: false,
        striped: false,//表格显示条纹，默认为false,设置为 true 会有隔行变色效果。
        ...
        queryParams: function (params) {// 请求服务器数据时发送的参数，可以在这里添加额外的查询参数
            return params;
        },
        ...
        pagination: false,// 在表格件底部显示分页组，默认false
        ...
        selectItemName: 'btSelectItem',// radio 或者 checkbox 的字段 name 名。
        ...
        uniqueId: undefined,// 对每一行指定唯一标识符。
        ...
        iconsPrefix: bs.iconsPrefix, // 定义字体库 ('Glyphicon' or 'fa' for FontAwesome)，使用"fa"时需引用 FontAwesome，并且配合 icons 属性实现效果。Glyphicon 集成于Bootstrap可免费使用
        icons: bs.icons,// 自定义图标
        customSearch: $.noop,// 自定义搜索方法来替代内置的搜索功能，它包含一个参数：  text：搜索文字。
        customSort: $.noop,// 自定义排序方法来替代内置的搜索功能，它包含一个参数：sortName: 排序名。sortOrder: 排序顺序。

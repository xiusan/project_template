$(function () {
    ...
    function c() {
        ...
        if (k) {
            var p = '<a  id="'+o+'" href="javascript:;" class="active J_menuTab" data-id="' + o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
...
function closeIframeAction() {
    ...
    $('.J_iframe[data-id="defaultValidate"]').remove();

    $('#defaultValidate').remove();

$.validator.setDefaults({
	highlight:function(e){
	    if(!$(e).attr("readonly") && !$(e).attr("disabled") && $(e).attr("required") == "required") {
		    $(e).closest(".form-group").removeClass("has-success").addClass("has-error")
	    }
	},
	success:function(e){
        if(!e.siblings("input").attr("readonly") && !e.siblings("input").attr("disabled") && e.siblings("input").attr("required") == "required") {
